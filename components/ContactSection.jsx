...
export default function ContactSection() {
  ...
  const contactDetails = [
    {
      icon: <MapPinIcon className="text-primary" size={22} suppressHydrationWarning />,
      title: "Address",
      value: "Delhi, India",
    },
    {
    ...
    <section id="contact-section" className="section-padding bg-black overflow-hidden pt-16 md:pt-20 pb-24 md:pb-10">
      <div className="container-custom">
        ...
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-gray-400 mb-8 md:mb-12 text-sm md:text-base">
            Based in Delhi, available worldwide. I communicate in English and Hindi
            and I'm comfortable working across time zones with international creators.
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {contactDetails.map((detail, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-[#0c1015] rounded-xl md:rounded-[20px] p-4 sm:p-6 md:p-8 flex flex-col items-center justify-center text-center shadow-lg hover:shadow-xl hover:shadow-primary/5 transition-all duration-300"
